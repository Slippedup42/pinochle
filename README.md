...
- **A contract the arithmetic has already killed never gets played**
  ...
  +13.78) with the fold model off, which is the rule's own size. Those
  figures, like every A/B number in this repo, were taken before #273
  corrected meld scoring and before four unmeasured bidding changes
  landed; the standing notice is at the head of `web/README.md`'s
  "Measuring the AI" section and re-measurement is #270 (#269).
